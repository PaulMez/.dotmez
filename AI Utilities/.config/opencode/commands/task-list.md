...
- Filter: default exclude status done. If --all, include all statuses. If --recurring, keep only recurring true (after status filter unless --all). If --no-recurring, exclude recurring tasks.
